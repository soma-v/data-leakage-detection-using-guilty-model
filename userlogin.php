	...
	<header class="mainHeader">
		...
		<nav>
			<ul>
				...
				<li class="active"><a href="userlogin.php?msg">UserLogin</a></li>
					...
					<form name="s" action="check_login_user.php" method="POST" onsubmit="return valid()">
						<table align="center" cellpadding="" cellspacing="" width="">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="username" id="username" class="b">
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="password" name="password" id="username"
										class="b"></td>
							</tr>
							<tr>
								<td>
